...
export const UPDATE_FORMATS: readonly UpdateFormat[] = Object.values(UPDATE_FORMAT);

type SquirrelWindowsPlatform =
  | typeof PLATFORM_ARCH.WIN_X64
  | typeof PLATFORM_ARCH.WIN_IA32
  | typeof PLATFORM_ARCH.WIN_ARM64;
type MsixPlatform = typeof PLATFORM_ARCH.WIN_X64_MSIX | typeof PLATFORM_ARCH.WIN_ARM64_MSIX;

export const SQUIRREL_TO_MSIX: Partial<Record<SquirrelWindowsPlatform, MsixPlatform>> = {
